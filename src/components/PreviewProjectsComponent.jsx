    ...
    return(
       <div className="container">
            <div className="flex flex-wrap justify-center md:justify-between items-center">
                <motion.img animate={{scale:[1,1.05,1]}} transition={{duration:1,times:[0,.5,1],ease:"easeInOut",repeat:Infinity}} className="drop-shadow-pllx-gray w-full h-[550px] object-cover lg:w-4/6" src={idefault} alt=""/>
